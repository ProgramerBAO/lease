...
public class ViewAppointmentController {
    ...
    @GetMapping("page")
    public Result<IPage<AppointmentVo>> page(@RequestParam Long current, @RequestParam Long size, @ParameterObject AppointmentQueryVo queryVo){
        IPage<AppointmentVo> page = new Page<>(1, 10);
