...
public class LoginServiceImpl implements LoginService {
    ...
    public String login(LoginVo loginVo) {
        ...
        } else if (Objects.equals(userInfo.getStatus(), BaseStatus.DISABLE)) {
            //4.判断用户是否被禁
